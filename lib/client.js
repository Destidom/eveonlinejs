 ...
 */
Client.prototype.setUrl = function (urlStr) { // add if dev url = https://api.testeveonline.com/
...
Client.prototype.fetch = function (path, params, cb) {
  ...
  var options = this.getRequestUrl(path, params)
    ...
    , cache = this.getCache()
    , self = this
    , userAgent = this.getParam('UserAgent'); // Fixes http://eveonline-third-party-documentation.readthedocs.org/en/latest/xmlapi/intro/#other-information 
  
  if (typeof userAgent === 'undefined') 
    userAgent = 'eveonline.js';
